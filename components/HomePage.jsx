      ...
      <nav className="bg-gradient-to-r from-emerald-700 via-green-700 to-emerald-800 p-6 shadow-2xl backdrop-blur-md border-b border-emerald-600/20 relative z-10">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center space-x-6">
            <button className="text-white/90 hover:text-white hover:scale-105 transition-all duration-300 font-medium px-3 py-2 rounded-lg hover:bg-white/10">
              About Us
            </button>
            <button className="bg-white/20 backdrop-blur-sm text-white border border-white/30 px-6 py-2 rounded-full hover:bg-white/30 hover:scale-105 transition-all duration-300 font-medium shadow-lg">
              Login
            </button>
            <button className="bg-gradient-to-r from-emerald-400 to-green-400 text-emerald-900 px-6 py-2 rounded-full hover:from-emerald-300 hover:to-green-300 hover:scale-105 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl">
              Sign Up
            </button>
          </div>
        </div>
